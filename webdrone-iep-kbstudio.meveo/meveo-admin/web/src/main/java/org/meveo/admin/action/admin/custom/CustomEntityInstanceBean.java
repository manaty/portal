...
public class CustomEntityInstanceBean extends CustomFieldBean<CustomEntityInstance> {
    ...
    public CustomEntityInstance initEntity() {
        ...
        Map<String, CustomFieldTemplate> cfts = customFieldTemplateService.findByAppliesTo(CustomEntityTemplate.getAppliesTo(customEntityTemplateCode));
        if (cfts != null) {
            fields = cfts;
...
//        return newValuesByCode
    ...
    public void setFields(Map<String, CustomFieldTemplate> fields) {
        this.fields = fields;
    }
