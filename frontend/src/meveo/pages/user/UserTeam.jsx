...
import UserTeamInfo from './UserTeamInfo.jsx';
...
class UserTeam extends Component {
    ...
    renderTeamMain(){
        return(
			<UserTeamInfo parent={this} users={this.state.users} userInfo={this.state.userInfo} {...this.state} baseData={this.state.baseData} backAllProfiles={this.backAllProfiles} projectInfo={this.state.projectInfo} countryAll={this.state.options}/>
        )
    }
