                    ...
                    <div key={index} className="project_team_list">
                        ...
                        <div className="in_pro">
                            ...
                            <div className="btn_pro">
                                <button className="btn_see_project" onClick={() => this.props.viewProfile(el.name)}>See
                                    profile
                                </button>
                            </div>
                        </div>
...
class SeeProjects extends Component {
    ...
    renderViewProfile() {
        return (
            <div>
                <SeeProfile parent={this} backAllProfiles={this.backAllProfiles}
                            userInfo={this.state.userInfo} {...this.state}
                            baseData={this.props.baseData} {...this.props}/>
            </div>
        );
    }
    ...
    setDataFormData() {
        ...
        if (projectSee != null) {
            ...
            state['projectSpaceLink'] = projectSee.projectSpaceLink;
            state['externalProjectSpace'] = projectSee.externalProjectSpace;
    ...
    renderSeeProject() {
        ...
        const linkTitle = this.props.projectSee.externalProjectSpace ?
                <span className="link_pro">
                                            <a target="_blank" href={this.props.projectSee.projectSpaceLink}>{this.props.projectSee.projectSpaceLink}&nbsp;</a>
                                        </span>
                : <span className="btn_space">
                <a target="_blank" href={this.props.projectSee.projectSpaceLink}>Access to project space</a>
                </span>
        return (
            <div className="my_profile" style={{ marginLeft:'0'}}>
                <div className="row">
                    <div class="project_scoll" id="hidingScrollBar">
                        <div class="hideScrollBar">
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 boder_header_pro">
                                <span className="name_header"><span
                                    onClick={this.props.backAllProjects}><label>PROJECTS</label></span> > {this.props.projectSee.code}</span>
                                <div onClick={this.props.backAllProjects}><label className="back_profile"><span
                                    className="name_back">Back to all projects</span>
                            ...
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 pro_page">
                                ...
                                <div className="body_project">
                                    ...
                                    <div className="body_left ">
                                        ...
                                        <div>
                                            <img onClick={this.togglePopupClient.bind(this)} src="images/icon/edit.png"
                                                 className="abso1"/>
                                        </div>
                                        <div className="in_see">
                                            <div className="left_pro">
                                                <div><img className="image_project"
                                                          src={"data:image/jpeg;base64," + photoDisplay}/></div>
                                            </div>
                                            <div className="client_see">Client
                                                : {this.props.projectSee.client}&nbsp;</div>
                                            <div
                                                className="short_pro">{this.props.projectSee.longDescription}&nbsp;</div>
                                            <div className="link_see_out">Link : {this.props.projectSee.link ?
                                                <a target="_blank" href={this.props.projectSee.link}
                                                   className="link_see">{this.props.projectSee.link}&nbsp;</a> : ''}</div>
                                        </div>
                                    ...
                                    <div className="body_right">
                                        ...
                                        {this.props.projectSee.teams && this.props.projectSee.teams.length !== 0 ?
                                            ...
                                            : null}
                                        <img onClick={this.togglePopupTeam.bind(this)} src="images/icon/edit.png"
                                             className="abso1"/>
                                    </div>
                                </div>
                            ...
                            {this.state.showPopupClient == true || this.state.showPopupTeam == true ?
