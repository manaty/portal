                            ...
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 pro_page">
                                ...
                                <div className="footer_project">
                                    <div className="header_see">
                                        ...
                                        <span className="link_pro">{this.props.projectSee.assemblaLink ?
                                            <a target="_blank"
                                               href={this.props.projectSee.assemblaLink}>{this.props.projectSee.assemblaLink}&nbsp;</a> : ''}</span>
                                    </div>

                                    <img onClick={this.togglePopupAssembla.bind(this)} src="images/icon/edit.png"
                                         className="abso1"/>
                                </div>
                            </div>
