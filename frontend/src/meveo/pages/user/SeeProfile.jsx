            ...
            <span>
                {this.props.projects.slice(0, this.props.itemsToShow).map((el, index) => (
                    <span key={index} className="project_profile">
                        <span className="full_project"><div className="manaty_see_project"
                                                            onClick={() => this.props.viewProject(el.name)}>{el.name}</div> - <span
...
class UserProfileInfo extends Component {
    ...
    renderViewProject() {
        return (
            <div>
                <SeeProjects parent={this} users={this.props.users} backAllProjects={this.props.backAllProjects}
                             resetFilter={this.resetFilter} projectSee={this.state.projectSee} {...this.state}
                ...
                <div className="row">
                    <div class="profile_scoll" id="hidingScrollBar" style={{marginLeft: "-12px"}}>
                        <div class="hideScrollBar">
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 boder_header"
                                 style={{marginLeft: "37px"}}>
                                <span className="name_header"><span
                                    onClick={this.props.backAllProfiles}><label>TEAM</label></span> > {this.state.form.name}</span>
                                <div onClick={this.props.backAllProfiles}><label className="back_profile"><span
                                    className="name_back">Back to all profiles</span>
                                ...
                                <section className="profile_infomation">
                                    ...
                                    <div className="image_pro">
                                        <div><img className="image"
                                                  src={"data:image/jpeg;base64," + this.state.photoBase64}/></div>
                                    ...
                                    <div className="infomation">
                                        ...
                                        <span className="btn_cv"
                                              onClick={this.generate_CV.bind(this)}>Export CV in PDF</span>
                                ...
                                <table className="table_profile">
                                        ...
                                        <td className="project">
                                            <div>
                                                ...
                                                <span className="display_project"><Projects
                                                    ...
                                                    viewProject={this.viewProject}/></span><br/>
                                    ...
                                    <tr>
                                        <td className="educations">
                                            <div>
                                                ...
                                                <div className="display_educations"><Educations
                                                    educations={this.state.form.educations}/></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td className="courses">
                                            ...
                                            <div className="display_courses"><Courses
                                                courses={this.state.form.courses}/></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="space">
