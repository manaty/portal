...
import {getAllUsers,getAllProject,editBioUser} from '../../actions/UserProfileAction';
...
class UserProfile extends Component {
	...
	componentWillMount() {
        ...
        AllStore.bindUpdateHandler(this.allUserDetail.bind(this));
	...
	renderUserProfileMain(){
        return(
			<UserProfileInfo parent={this} userInfo={this.state.userInfo}  statusUser={this.state.statusUser} {...this.state} baseData={this.state.baseData} projectSee={this.state.projectSee} projectInfo={this.state.projectInfo} countryAll={this.state.options}/>
		)
	}
